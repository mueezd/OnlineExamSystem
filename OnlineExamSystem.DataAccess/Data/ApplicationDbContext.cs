...
namespace OnlineExamSystem.DataAccess.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Students>(entity =>
            {
                ...
                entity.Property(e => e.PrctureFileName).HasMaxLength(250);
            ...
            modelBuilder.Entity<QnAs>(entity =>
            {
                ...
                entity.Property(e => e.Option1).IsRequired().HasMaxLength(150);
                entity.Property(e => e.Option2).IsRequired().HasMaxLength(150);
                entity.Property(e => e.Option3).IsRequired().HasMaxLength(150);
                entity.Property(e => e.Option4).IsRequired().HasMaxLength(150);
